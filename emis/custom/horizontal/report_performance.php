				...
				<div class="row page-titles">
					<div class="col-md-5 col-8 align-self-center">
						...
						<ol class="breadcrumb">
							...
							<form action="report_performance.php" method="POST">
								<div class="col-12">
									<div class="row">
													...
													<tbody id="companyData">
														<?php
															...
															if(isset($_POST['from_date']))
															{
																...
																$sql = "SELECT * FROM employees_performance WHERE date='$today'";
															...
															if ($result->num_rows > 0) 
															{
																while( $row = mysqli_fetch_array($result))
																{
																	...
																	while( $row1 = mysqli_fetch_array($result1))
																	{
																		...
																		{
																			$ppe=$row1['ppe'];
																			$gentle=$row1['gentle_atitude'];
																			$house=$row1['house_keeping'];
																			$client=$row1['client_relation'];
																			$employee=$row1['employee_relation'];
																			$technical=$row1['technical_work'];
																			$qhse=$row1['qhse'];
																			break;
																		}
																	}
