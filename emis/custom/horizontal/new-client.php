<?php
	...
	if(isset($_POST['client_name']) && isset($_POST['phone_number']) && isset($_POST['email']) && isset($_POST['feedback']))
	{
		...
		$sql="SELECT * from clients WHERE phone_number='$phone_number'";
		...
		{
			$sql="INSERT INTO clients (client_name,phone_number,email,feedback) 
			VALUES ('$client_name','$phone_number','$email','$feedback')";
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
								...
								<form action="new-client.php" method="POST" class="form-horizontal">
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input id="" type="text" placeholder="Client Name" name="client_name" class=" form-control" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="row">
											...
											<div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input disabled id="" value="<?php echo date('Y-m-d'); ?>" type="date" name="date" class=" form-control">
                                                    </div>
                                                </div>
                                            </div>
										...
										<div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input id="" type="text" placeholder="Feedback" name="feedback" class=" form-control" required>
                                                    </div>
                                                </div>
                                            </div>
