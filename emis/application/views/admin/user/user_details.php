...
<div class="row mt-lg">
    ...
    -->
    <div class="col-sm-12">
        <div class="tab-content" style="border: 0;padding-left:16px; padding-right:16px;">
...
<?php
	...
	if($userId!="")
	{
		...
		else
		{
			...
			{
                                echo '<div class=col-sm-12><table class="table table-striped DataTables" id="book-table" cellspacing="0" width="100%">';
                                echo "<th>User Id</th>";
				...
				{
					echo "<tr><td>".$userId."</td> <td>".$row[$i]."</td> <td>".$row1[$i]."</td></tr>";
				}
