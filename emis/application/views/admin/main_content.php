...
$user_data = $this->db->where('user_id',$this->session->userdata('user_id'))->get('tbl_account_details')->row();

$user_name = $this->db->where('user_id',$this->session->userdata('user_id'))->get('tbl_users')->row();
...
<div class="dashboard">
	...
	<div class="col-sm-6">
		...
		<div class="panel panel-custom menu" style="overflow:auto;height:400px;">
		<section class="scrollable">
			<div class="panel-heading" style="ouline:1px solid red;">
				<h3 class="panel-title">Forms</h3>
                            
			</div>
			<form action='dashboard' method='POST'>
				<p style="display:inline-block; margin-left:20px;">From:</p>
					 <input style=" margin-right:10px; display:inline-block; width:150px;" type="text" name="start_date" class="form-control datepicker" value="2018-04-25" data-date-format="yyyy.mm.dd">
				<p style="display:inline-block; margin-left:10px;">To:</p>
					 <input style=" margin-right:10px; display:inline-block; width:150px;" type="text" name="end_date" class="form-control datepicker" value="2018-04-25" data-date-format="yyyy.mm.dd">

				<button type="submit" class="btn btn-default" style="margin-left:5px; width:100px; height:33px; inline-block;">
			...
			<table class="table table-striped DataTables" id="book-table" cellspacing="0" width="100%">
				...
				<tbody>
					<?php
						...
						{
							if($user_data->designations_id==0)
							{
								if(!isset($_POST['start_date']) && !isset($_POST['end_date']))
								{
									$sql_u = "SELECT (SELECT COUNT(id) FROM form1survey) as table1Count, 
										  (SELECT COUNT(id) FROM form2survey) as table2Count,
										  (SELECT COUNT(id) FROM form3survey) as table3Count,
										  (SELECT COUNT(id) FROM form4survey) as table4Count,
                                          (SELECT COUNT(id) FROM form5survey) as table5Count,
                                          (SELECT COUNT(id) FROM form6survey) as table6Count,
                                          (SELECT COUNT(id) FROM form7survey) as table7Count,
                                          (SELECT COUNT(id) FROM form8survey) as table8Count,
                                          (SELECT COUNT(id) FROM form9survey) as table9Count,
                                          (SELECT COUNT(id) FROM form10survey) as table10Count,			
                                          (SELECT COUNT(id) FROM form11survey) as table11Count,
                                          (SELECT COUNT(id) FROM form12survey) as table12Count";
										  
									$res_u = mysqli_query($con, $sql_u);	

									$sql_u = "SELECT (SELECT COUNT(id) from form1survey WHERE isVerified='Verified') as table1Count, 
										(SELECT COUNT(id) from form2survey WHERE isVerified='Verified') as table2Count,
										(SELECT COUNT(id) from form3survey WHERE isVerified='Verified') as table3Count,
										(SELECT COUNT(id) from form4survey WHERE isVerified='Verified') as table4Count,
										(SELECT COUNT(id) from form5survey WHERE isVerified='Verified') as table5Count,
										(SELECT COUNT(id) from form6survey WHERE isVerified='Verified') as table6Count,
										(SELECT COUNT(id) from form7survey WHERE isVerified='Verified') as table7Count,
										(SELECT COUNT(id) from form8survey WHERE isVerified='Verified') as table8Count,
										(SELECT COUNT(id) from form9survey WHERE isVerified='Verified') as table9Count,
										(SELECT COUNT(id) from form10survey WHERE isVerified='Verified') as table10Count,
										(SELECT COUNT(id) from form11survey WHERE isVerified='Verified') as table11Count,
										(SELECT COUNT(id) from form12survey WHERE isVerified='Verified') as table12Count";
								...
								else
								{
									...
									$sql_u = "SELECT (SELECT COUNT(id) FROM form1survey WHERE(date BETWEEN '$startDate' AND '$endDate')) as table1Count, 
										  (SELECT COUNT(id) FROM form2survey WHERE(date BETWEEN '$startDate' AND '$endDate')) as table2Count,
										  (SELECT COUNT(id) FROM form3survey WHERE(date BETWEEN '$startDate' AND '$endDate')) as table3Count,
										  (SELECT COUNT(id) FROM form4survey WHERE(date BETWEEN '$startDate' AND '$endDate')) as table4Count,
                                          (SELECT COUNT(id) FROM form5survey WHERE(date BETWEEN '$startDate' AND '$endDate')) as table5Count,
                                          (SELECT COUNT(id) FROM form6survey WHERE(date BETWEEN '$startDate' AND '$endDate')) as table6Count,
                                          (SELECT COUNT(id) FROM form7survey WHERE(date BETWEEN '$startDate' AND '$endDate')) as table7Count,
                                          (SELECT COUNT(id) FROM form8survey WHERE(date BETWEEN '$startDate' AND '$endDate')) as table8Count,
                                          (SELECT COUNT(id) FROM form9survey WHERE(date BETWEEN '$startDate' AND '$endDate')) as table9Count,
                                          (SELECT COUNT(id) FROM form10survey WHERE(date BETWEEN '$startDate' AND '$endDate')) as table10Count,			
                                          (SELECT COUNT(id) FROM form11survey WHERE(date BETWEEN '$startDate' AND '$endDate')) as table11Count,
                                          (SELECT COUNT(id) FROM form12survey WHERE(date BETWEEN '$startDate' AND '$endDate')) as table12Count";
										  
									$res_u = mysqli_query($con, $sql_u);	

									$sql_u = "SELECT (SELECT COUNT(id) from form1survey WHERE (date BETWEEN '$startDate' AND '$endDate') AND isVerified='Verified') as table1Count, 
										(SELECT COUNT(id) from form2survey WHERE (date BETWEEN '$startDate' AND '$endDate') AND isVerified='Verified') as table2Count,
										(SELECT COUNT(id) from form3survey WHERE (date BETWEEN '$startDate' AND '$endDate') AND isVerified='Verified') as table3Count,
										(SELECT COUNT(id) from form4survey WHERE (date BETWEEN '$startDate' AND '$endDate') AND isVerified='Verified') as table4Count,
										(SELECT COUNT(id) from form5survey WHERE (date BETWEEN '$startDate' AND '$endDate') AND isVerified='Verified') as table5Count,
										(SELECT COUNT(id) from form6survey WHERE (date BETWEEN '$startDate' AND '$endDate') AND isVerified='Verified') as table6Count,
										(SELECT COUNT(id) from form7survey WHERE (date BETWEEN '$startDate' AND '$endDate') AND isVerified='Verified') as table7Count,
										(SELECT COUNT(id) from form8survey WHERE (date BETWEEN '$startDate' AND '$endDate') AND isVerified='Verified') as table8Count,
										(SELECT COUNT(id) from form9survey WHERE (date BETWEEN '$startDate' AND '$endDate') AND isVerified='Verified') as table9Count,
										(SELECT COUNT(id) from form10survey WHERE (date BETWEEN '$startDate' AND '$endDate') AND isVerified='Verified') as table10Count,
										(SELECT COUNT(id) from form11survey WHERE (date BETWEEN '$startDate' AND '$endDate') AND isVerified='Verified') as table11Count,
										(SELECT COUNT(id) from form12survey WHERE (date BETWEEN '$startDate' AND '$endDate') AND isVerified='Verified') as table12Count";
								}
							}
							else if($user_data->designations_id==1)
							{
								if(!isset($_POST['start_date']) && !isset($_POST['end_date']))
								{
									$sql_u = "SELECT (SELECT COUNT(id) from form1survey INNER join tbl_users on tbl_users.username=form1survey.email inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id) as table1Count,
									(SELECT COUNT(id) from form2survey INNER join tbl_users on tbl_users.username=form2survey.email inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id) as table2Count,
									(SELECT COUNT(id) from form3survey INNER join tbl_users on tbl_users.username=form3survey.email inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id) as table3Count,
									(SELECT COUNT(id) from form4survey INNER join tbl_users on tbl_users.username=form4survey.email inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id) as table4Count,
									(SELECT COUNT(id) from form5survey INNER join tbl_users on tbl_users.username=form5survey.email inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id) as table5Count,
									(SELECT COUNT(id) from form6survey INNER join tbl_users on tbl_users.username=form6survey.email inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id) as table6Count,
									(SELECT COUNT(id) from form7survey INNER join tbl_users on tbl_users.username=form7survey.email inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id) as table7Count,
									(SELECT COUNT(id) from form8survey INNER join tbl_users on tbl_users.username=form8survey.email inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id) as table8Count,
									(SELECT COUNT(id) from form9survey INNER join tbl_users on tbl_users.username=form9survey.email inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id) as table9Count,
									(SELECT COUNT(id) from form10survey INNER join tbl_users on tbl_users.username=form10survey.email inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id) as table10Count,
									(SELECT COUNT(id) from form11survey INNER join tbl_users on tbl_users.username=form11survey.email inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id) as table11Count,
									(SELECT COUNT(id) from form12survey INNER join tbl_users on tbl_users.username=form12survey.email inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id) as table12Count";
									
									$res_u = mysqli_query($con, $sql_u);
									
									$sql_u = "SELECT (SELECT COUNT(id) from form1survey INNER join tbl_users on tbl_users.username=form1survey.email AND form1survey.isVerified='Verified' inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id) as table1Count,
									(SELECT COUNT(id) from form2survey INNER join tbl_users on tbl_users.username=form2survey.email AND form2survey.isVerified='Verified' inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id) as table2Count,
									(SELECT COUNT(id) from form3survey INNER join tbl_users on tbl_users.username=form3survey.email AND form3survey.isVerified='Verified' inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id) as table3Count,
									(SELECT COUNT(id) from form4survey INNER join tbl_users on tbl_users.username=form4survey.email AND form4survey.isVerified='Verified' inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id) as table4Count,
									(SELECT COUNT(id) from form5survey INNER join tbl_users on tbl_users.username=form5survey.email AND form5survey.isVerified='Verified' inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id) as table5Count,
									(SELECT COUNT(id) from form6survey INNER join tbl_users on tbl_users.username=form6survey.email AND form6survey.isVerified='Verified' inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id) as table6Count,
									(SELECT COUNT(id) from form7survey INNER join tbl_users on tbl_users.username=form7survey.email AND form7survey.isVerified='Verified' inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id) as table7Count,
									(SELECT COUNT(id) from form8survey INNER join tbl_users on tbl_users.username=form8survey.email AND form8survey.isVerified='Verified' inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id) as table8Count,
									(SELECT COUNT(id) from form9survey INNER join tbl_users on tbl_users.username=form9survey.email AND form9survey.isVerified='Verified' inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id) as table9Count,
									(SELECT COUNT(id) from form10survey INNER join tbl_users on tbl_users.username=form10survey.email AND form10survey.isVerified='Verified' inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id) as table10Count,
									(SELECT COUNT(id) from form11survey INNER join tbl_users on tbl_users.username=form11survey.email AND form11survey.isVerified='Verified' inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id) as table11Count,
									(SELECT COUNT(id) from form12survey INNER join tbl_users on tbl_users.username=form12survey.email AND form12survey.isVerified='Verified' inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id) as table12Count";
								}
								else
								{
									$startDate= $_POST['start_date'];
									...
									$sql_u = "SELECT (SELECT COUNT(id) from form1survey INNER join tbl_users on tbl_users.username=form1survey.email inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id AND form1survey.date BETWEEN '$startDate' AND '$endDate') as table1Count,
									(SELECT COUNT(id) from form2survey INNER join tbl_users on tbl_users.username=form2survey.email inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id AND form2survey.date BETWEEN '$startDate' AND '$endDate') as table2Count,
									(SELECT COUNT(id) from form3survey INNER join tbl_users on tbl_users.username=form3survey.email inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id AND form3survey.date BETWEEN '$startDate' AND '$endDate') as table3Count,
									(SELECT COUNT(id) from form4survey INNER join tbl_users on tbl_users.username=form4survey.email inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id AND form4survey.date BETWEEN '$startDate' AND '$endDate') as table4Count,
									(SELECT COUNT(id) from form5survey INNER join tbl_users on tbl_users.username=form5survey.email inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id AND form5survey.date BETWEEN '$startDate' AND '$endDate') as table5Count,
									(SELECT COUNT(id) from form6survey INNER join tbl_users on tbl_users.username=form6survey.email inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id AND form6survey.date BETWEEN '$startDate' AND '$endDate') as table6Count,
									(SELECT COUNT(id) from form7survey INNER join tbl_users on tbl_users.username=form7survey.email inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id AND form7survey.date BETWEEN '$startDate' AND '$endDate') as table7Count,
									(SELECT COUNT(id) from form8survey INNER join tbl_users on tbl_users.username=form8survey.email inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id AND form8survey.date BETWEEN '$startDate' AND '$endDate') as table8Count,
									(SELECT COUNT(id) from form9survey INNER join tbl_users on tbl_users.username=form9survey.email inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id AND form9survey.date BETWEEN '$startDate' AND '$endDate') as table9Count,
									(SELECT COUNT(id) from form10survey INNER join tbl_users on tbl_users.username=form10survey.email inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id AND form10survey.date BETWEEN '$startDate' AND '$endDate') as table10Count,
									(SELECT COUNT(id) from form11survey INNER join tbl_users on tbl_users.username=form11survey.email inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id AND form11survey.date BETWEEN '$startDate' AND '$endDate') as table11Count,
									(SELECT COUNT(id) from form12survey INNER join tbl_users on tbl_users.username=form12survey.email inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id AND form12survey.date BETWEEN '$startDate' AND '$endDate') as table12Count";
									
									$res_u = mysqli_query($con, $sql_u);
									
									$sql_u = "SELECT (SELECT COUNT(id) from form1survey INNER join tbl_users on tbl_users.username=form1survey.email AND form1survey.isVerified='Verified' inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id AND form1survey.date BETWEEN '$startDate' AND '$endDate') as table1Count,
									(SELECT COUNT(id) from form2survey INNER join tbl_users on tbl_users.username=form2survey.email AND form2survey.isVerified='Verified' inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id AND form2survey.date BETWEEN '$startDate' AND '$endDate') as table2Count,
									(SELECT COUNT(id) from form3survey INNER join tbl_users on tbl_users.username=form3survey.email AND form3survey.isVerified='Verified' inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id AND form3survey.date BETWEEN '$startDate' AND '$endDate') as table3Count,
									(SELECT COUNT(id) from form4survey INNER join tbl_users on tbl_users.username=form4survey.email AND form4survey.isVerified='Verified' inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id AND form4survey.date BETWEEN '$startDate' AND '$endDate') as table4Count,
									(SELECT COUNT(id) from form5survey INNER join tbl_users on tbl_users.username=form5survey.email AND form5survey.isVerified='Verified' inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id AND form5survey.date BETWEEN '$startDate' AND '$endDate') as table5Count,
									(SELECT COUNT(id) from form6survey INNER join tbl_users on tbl_users.username=form6survey.email AND form6survey.isVerified='Verified' inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id AND form6survey.date BETWEEN '$startDate' AND '$endDate') as table6Count,
									(SELECT COUNT(id) from form7survey INNER join tbl_users on tbl_users.username=form7survey.email AND form7survey.isVerified='Verified' inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id AND form7survey.date BETWEEN '$startDate' AND '$endDate') as table7Count,
									(SELECT COUNT(id) from form8survey INNER join tbl_users on tbl_users.username=form8survey.email AND form8survey.isVerified='Verified' inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id AND form8survey.date BETWEEN '$startDate' AND '$endDate') as table8Count,
									(SELECT COUNT(id) from form9survey INNER join tbl_users on tbl_users.username=form9survey.email AND form9survey.isVerified='Verified' inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id AND form9survey.date BETWEEN '$startDate' AND '$endDate') as table9Count,
									(SELECT COUNT(id) from form10survey INNER join tbl_users on tbl_users.username=form10survey.email AND form10survey.isVerified='Verified' inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id AND form10survey.date BETWEEN '$startDate' AND '$endDate') as table10Count,
									(SELECT COUNT(id) from form11survey INNER join tbl_users on tbl_users.username=form11survey.email AND form11survey.isVerified='Verified' inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id AND form11survey.date BETWEEN '$startDate' AND '$endDate') as table11Count,
									(SELECT COUNT(id) from form12survey INNER join tbl_users on tbl_users.username=form12survey.email AND form12survey.isVerified='Verified' inner join tbl_account_details on tbl_account_details.user_id=tbl_users.user_id AND tbl_account_details.head=$user_data->user_id AND form12survey.date BETWEEN '$startDate' AND '$endDate') as table12Count";
									
								}
							}
							else if($user_data->designations_id==2)
							{
								if(!isset($_POST['start_date']) && !isset($_POST['end_date']))
								{
									$sql_u = "SELECT (SELECT COUNT(id) FROM form1survey WHERE email='$user_name->username') as table1Count,
									(SELECT COUNT(id) FROM form2survey WHERE email='$user_name->username') as table2Count,
									(SELECT COUNT(id) FROM form3survey WHERE email='$user_name->username') as table3Count,
									(SELECT COUNT(id) FROM form4survey WHERE email='$user_name->username') as table4Count,
									(SELECT COUNT(id) FROM form5survey WHERE email='$user_name->username') as table5Count,
									(SELECT COUNT(id) FROM form6survey WHERE email='$user_name->username') as table6Count,
									(SELECT COUNT(id) FROM form7survey WHERE email='$user_name->username') as table7Count,
									(SELECT COUNT(id) FROM form8survey WHERE email='$user_name->username') as table8Count,
									(SELECT COUNT(id) FROM form9survey WHERE email='$user_name->username') as table9Count,
									(SELECT COUNT(id) FROM form10survey WHERE email='$user_name->username') as table10Count,
									(SELECT COUNT(id) FROM form11survey WHERE email='$user_name->username') as table11Count,
									(SELECT COUNT(id) FROM form12survey WHERE email='$user_name->username') as table12Count";
																					 
									$res_u = mysqli_query($con, $sql_u);
								
									$sql_u = "SELECT (SELECT COUNT(id) FROM form1survey WHERE email='$user_data->user_id' AND isVerified='Verified') as table1Count, 
									(SELECT COUNT(id) FROM form2survey WHERE email='$user_name->username' AND isVerified='Verified') as table2Count,
									(SELECT COUNT(id) FROM form3survey WHERE email='$user_name->username' AND isVerified='Verified') as table3Count,
									(SELECT COUNT(id) FROM form4survey WHERE email='$user_name->username' AND isVerified='Verified') as table4Count,
									(SELECT COUNT(id) FROM form5survey WHERE email='$user_name->username' AND isVerified='Verified') as table5Count,
									(SELECT COUNT(id) FROM form6survey WHERE email='$user_name->username' AND isVerified='Verified') as table6Count,
									(SELECT COUNT(id) FROM form7survey WHERE email='$user_name->username' AND isVerified='Verified') as table7Count,
									(SELECT COUNT(id) FROM form8survey WHERE email='$user_name->username' AND isVerified='Verified') as table8Count,
									(SELECT COUNT(id) FROM form9survey WHERE email='$user_name->username' AND isVerified='Verified') as table9Count,
									(SELECT COUNT(id) FROM form10survey WHERE email='$user_name->username' AND isVerified='Verified') as table10Count,
									(SELECT COUNT(id) FROM form11survey WHERE email='$user_name->username' AND isVerified='Verified') as table11Count,
									(SELECT COUNT(id) FROM form12survey WHERE email='$user_name->username' AND isVerified='Verified') as table12Count";
								}
								else
								{
									$startDate= $_POST['start_date'];
									...
									$sql_u = "SELECT (SELECT COUNT(id) FROM form1survey WHERE email='$user_name->username' AND date BETWEEN '$startDate' AND '$endDate') as table1Count,
									(SELECT COUNT(id) FROM form2survey WHERE email='$user_name->username' AND date BETWEEN '$startDate' AND '$endDate') as table2Count,
									(SELECT COUNT(id) FROM form3survey WHERE email='$user_name->username' AND date BETWEEN '$startDate' AND '$endDate') as table3Count,
									(SELECT COUNT(id) FROM form4survey WHERE email='$user_name->username' AND date BETWEEN '$startDate' AND '$endDate') as table4Count,
									(SELECT COUNT(id) FROM form5survey WHERE email='$user_name->username' AND date BETWEEN '$startDate' AND '$endDate') as table5Count,
									(SELECT COUNT(id) FROM form6survey WHERE email='$user_name->username' AND date BETWEEN '$startDate' AND '$endDate') as table6Count,
									(SELECT COUNT(id) FROM form7survey WHERE email='$user_name->username' AND date BETWEEN '$startDate' AND '$endDate') as table7Count,
									(SELECT COUNT(id) FROM form8survey WHERE email='$user_name->username' AND date BETWEEN '$startDate' AND '$endDate') as table8Count,
									(SELECT COUNT(id) FROM form9survey WHERE email='$user_name->username' AND date BETWEEN '$startDate' AND '$endDate') as table9Count,
									(SELECT COUNT(id) FROM form10survey WHERE email='$user_name->username' AND date BETWEEN '$startDate' AND '$endDate') as table10Count,
									(SELECT COUNT(id) FROM form11survey WHERE email='$user_name->username' AND date BETWEEN '$startDate' AND '$endDate') as table11Count,
									(SELECT COUNT(id) FROM form12survey WHERE email='$user_name->username' AND date BETWEEN '$startDate' AND '$endDate') as table12Count";
																					 
									$res_u = mysqli_query($con, $sql_u);
								
									$sql_u = "SELECT (SELECT COUNT(id) FROM form1survey WHERE email='$user_data->user_id' AND isVerified='Verified' AND date BETWEEN '$startDate' AND '$endDate') as table1Count, 
									(SELECT COUNT(id) FROM form2survey WHERE email='$user_name->username' AND isVerified='Verified' AND date BETWEEN '$startDate' AND '$endDate') as table2Count,
									(SELECT COUNT(id) FROM form3survey WHERE email='$user_name->username' AND isVerified='Verified' AND date BETWEEN '$startDate' AND '$endDate') as table3Count,
									(SELECT COUNT(id) FROM form4survey WHERE email='$user_name->username' AND isVerified='Verified' AND date BETWEEN '$startDate' AND '$endDate') as table4Count,
									(SELECT COUNT(id) FROM form5survey WHERE email='$user_name->username' AND isVerified='Verified' AND date BETWEEN '$startDate' AND '$endDate') as table5Count,
									(SELECT COUNT(id) FROM form6survey WHERE email='$user_name->username' AND isVerified='Verified' AND date BETWEEN '$startDate' AND '$endDate') as table6Count,
									(SELECT COUNT(id) FROM form7survey WHERE email='$user_name->username' AND isVerified='Verified' AND date BETWEEN '$startDate' AND '$endDate') as table7Count,
									(SELECT COUNT(id) FROM form8survey WHERE email='$user_name->username' AND isVerified='Verified' AND date BETWEEN '$startDate' AND '$endDate') as table8Count,
									(SELECT COUNT(id) FROM form9survey WHERE email='$user_name->username' AND isVerified='Verified' AND date BETWEEN '$startDate' AND '$endDate') as table9Count,
									(SELECT COUNT(id) FROM form10survey WHERE email='$user_name->username' AND isVerified='Verified' AND date BETWEEN '$startDate' AND '$endDate') as table10Count,
									(SELECT COUNT(id) FROM form11survey WHERE email='$user_name->username' AND isVerified='Verified' AND date BETWEEN '$startDate' AND '$endDate') as table11Count,
									(SELECT COUNT(id) FROM form12survey WHERE email='$user_name->username' AND isVerified='Verified' AND date BETWEEN '$startDate' AND '$endDate') as table12Count";
							...
							if (mysqli_num_rows($res_u) > 0) 
							{
								...
								{
									$datapoints[]=array("formNo"=>($i+1),"formSubmission"=>$row[$i],"formVerification"=>$row1[$i]);
									echo "<tr>";
									echo "<td>Form ".($i+1)."</td>";
									echo "<td>".$row[$i]."</td>";
									echo "<td>".$row1[$i]."</td>";
	...
	<div class="col-sm-6">
		<div class="panel panel-custom menu" style="height:400px;">
...
<link rel="stylesheet" href="https://www.amcharts.com/lib/3/plugins/export/export.css" type="text/css" media="all" />
				...
				var chart = AmCharts.makeChart("chartdiv", {
					...
					"startDuration": 1,
					"graphs": [{
						"balloonText": "Form [[category]] Submission: <b>[[value]]</b>",
						"fillAlphas": 0.9,
						"lineAlpha": 0.2,
						"type": "column",
						"valueField": "formSubmission"
					}, {
						"balloonText": "Form [[category]] Verification: <b>[[value]]</b>",
						"fillAlphas": 0.9,
						"lineAlpha": 0.2,
						"type": "column",
						"clustered":false,
						"columnWidth":0.3,
						"valueField": "formVerification"
					}],
					"plotAreaFillAlphas": 0.1,
					"categoryField": "formNo",
					"categoryAxis": {
						"gridPosition": "start"
					},
					"export": {
	...
	<div class="col-sm-12">
		<div class="panel panel-custom menu" style="height:510px;">
			<div class="panel-heading">
				<h3 class="panel-title">Ploting</h3>
			</div>
			<div class="panel-body">
				<iframe src="../../survey/location_dashboard.php" style="background:none; border:0px solid red;" height="420px" width="100%"></iframe>
			</div>
