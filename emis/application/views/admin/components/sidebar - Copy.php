        ...
        <nav data-sidebar-anyclick-close="" class="sidebar">
            ...
            <ul class="nav pinned">
                ...
                <?php endif; ?>
					...
					<li class="pinned_list mb">
                        <a data-placement="top" data-toggle="tooltip" href="<?= base_url() ?>admin/raw" >Graphs</a>
                    </li>
					
					<li class="pinned_list mb">
                        <a data-placement="top" data-toggle="tooltip" href="<?= base_url() ?>admin/loginlist" >App Credentials</a>
                    </li>
