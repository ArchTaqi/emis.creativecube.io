    ...
    public function save_user()
    {
        ...
        if (!empty($created) || !empty($edited)) {
            ...
            if (!empty($check_user) || !empty($check_email)) { // if input data already exist show error alert
                ...
                $profile_data = $this->user_model->array_from_post(array('fullname', 'employment_id', 'company', 'city', 'locale','language', 'phone', 'mobile', 'skype', 'designations_id','head','direction'));
